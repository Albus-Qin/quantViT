...
from .layers_quant import (DropPath, HybridEmbed, Mlp, PatchEmbed, to_2tuple,
                           trunc_normal_)
from .ptq import QAct, QConv2d, QIntLayerNorm, QIntSoftmax, QLinear, QPreSoftmaxAct, QGELU
...
class SwinTransformer(nn.Module):
    ...
    def model_quant(self):
        for m in self.modules():
            if type(m) in [QAct, QConv2d, QIntLayerNorm, QIntSoftmax, QLinear, QPreSoftmaxAct]:
                m.quant = True
